  ...
  try {
    ...
    function optionBox() { // 配置界面
      ...
      optionBox.innerHTML = [
        ...
        '  <div>',
        '    <button class="testAudio_Common"><l0>播放</l0><l1>播放</l1><l2>Play</l2></button><input id="audioEnable_Common" type="checkbox"><label for="audioEnable_Common"><l01>通用</l01><l2>Common</l2>: <input name="audio_Common" placeholder="https://github.com/dodying/UserJs/raw/master/HentaiVerse/hvAutoAttack/Common.ogg" type="text"></label><br>',
        '    <button class="testAudio_Error"><l0>播放</l0><l1>播放</l1><l2>Play</l2></button><input id="audioEnable_Error" type="checkbox"><label for="audioEnable_Error"><l0>错误</l0><l1>錯誤</l1><l2>Error</l2>: <input name="audio_Error" placeholder="https://github.com/dodying/UserJs/raw/master/HentaiVerse/hvAutoAttack/Error.ogg" type="text"></label><br>',
        '    <button class="testAudio_Defeat"><l0>播放</l0><l1>播放</l1><l2>Play</l2></button><input id="audioEnable_Defeat" type="checkbox"><label for="audioEnable_Defeat"><l0>失败</l0><l1>失敗</l1><l2>Defeat</l2>: <input name="audio_Defeat" placeholder="https://github.com/dodying/UserJs/raw/master/HentaiVerse/hvAutoAttack/Defeat.ogg" type="text"></label><br>',
        '    <button class="testAudio_Riddle"><l0>播放</l0><l1>播放</l1><l2>Play</l2></button><input id="audioEnable_Riddle" type="checkbox"><label for="audioEnable_Riddle"><l0>答题</l0><l1>答題</l1><l2>Riddle</l2>: <input name="audio_Riddle"  placeholder="https://github.com/dodying/UserJs/raw/master/HentaiVerse/hvAutoAttack/Riddle.ogg" type="text"></label><br>',
        '    <button class="testAudio_Victory"><l0>播放</l0><l1>播放</l1><l2>Play</l2></button><input id="audioEnable_Victory" type="checkbox"><label for="audioEnable_Victory"><l0>胜利</l0><l1>勝利</l1><l2>Victory</l2>: <input name="audio_Victory"  placeholder="https://github.com/dodying/UserJs/raw/master/HentaiVerse/hvAutoAttack/Victory.ogg" type="text"></label></div>',
