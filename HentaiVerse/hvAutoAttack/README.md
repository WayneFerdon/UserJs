...
9. `targetHp`、`targetMp`、`targetSp`、`targetBuffTurn`: 目标怪物的HP%、SP%、MP%、buff剩余时间，`_targetBuffTurn_`后缀参照`targetBuffTurn`（如：`_targetBuffTurn_bleed,6,0`表示目标bleed的buff剩余回合不等于0）。target的目标怪物遵循以下规则
    ...
    ![示例](https://github.com/user-attachments/assets/6171d4a5-53d4-4af4-908e-c8182b9ded41)   
